...
const handlers = [
  ...
  http.get(`${AKOYA_PRODUCT_PATH}/accounts-info/v2/mikomo`, ({request}) =>{
      return HttpResponse.json(accountsData);
  }),
  http.get(`${AKOYA_PRODUCT_PROD_PATH}/accounts-info/v2/mikomo`, ({request}) =>{
      return HttpResponse.json(accountsData);
  }),
  ...
  http.get(`${AKOYA_PRODUCT_PATH}/transactions/v2/mikomo/839502593?offset=0&limit=50`, () => {
    return HttpResponse.json(transactionData)
  }),
  http.get(`${AKOYA_PRODUCT_PROD_PATH}/transactions/v2/mikomo/839502593?offset=0&limit=50`, () => {
    return HttpResponse.json(transactionData)
  }),
